...
namespace ZipToInfo.Models
{
    public class ZipInfo
    {
        ...
        {
            return $"At the location {CityName} ({ZipCode}), the temperature is {CurrentTemperatureFahrenheit} &deg;F, the timezone is {TimeZone.DisplayName}, and the elevation is {ElevationInFeet} ft.";
        }
    }
}